...
#' @param miss_val The value (numeric or character) that indicate missing data/absences in the data. If 
...
#' @param high_val The value (numeric or character) that indicate the highest ordinal outcome possible, 
...
#' @param low_val The value (numeric or character) that indicates the lowest ordinal outcome possible, 
