...
#' @param object A fitted \code{idealstan} object with true data from \code{\link{id_sim_gen}}
...
#' @param object A fitted \code{idealstan} object with true data generated by \code{\link{id_sim_gen}}
