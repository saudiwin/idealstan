...
bin_time_irt_2pl_abs_sim <- id_sim_gen(num_person=20,num_items=200,
                                       ordinal=F,inflate=F,
...
#bin_time_irt_2pl_abs_sim <- readRDS("rw_sim.rds")
...
bin_time_irt_2pl_abs_est <- id_estimate(idealdata=bin_time_irt_2pl_abs_sim,
                               model_type=1,nchains=2,ncores = 6,
...
bin_time_spline_irt_2pl_abs_sim <- id_sim_gen(num_person=10,num_items=66,inflate=F,
                               absence_diff_mean=0,
                               time_process = 'splines',
                               time_points=3,time_sd = .25,
                               spline_degree=1)

# bin_time_spline_irt_2pl_abs_sim <- readRDS("spline_sim.rds")
...
bin_time_spline_irt_2pl_abs_est <- id_estimate(idealdata=bin_time_spline_irt_2pl_abs_sim,
                               ...
                               vary_ideal_pts = 'splines',prior_only = TRUE,
                               spline_knots=NULL,spline_degree = 1,
...
id_show_trues(bin_time_spline_irt_2pl_abs_est,type='Residuals')

```

```{r irt_2pl_time_spline_abs_RMSE}

id_show_trues(bin_time_spline_irt_2pl_abs_est)
