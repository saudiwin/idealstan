...
bin_irt_2pl_est <- id_estimate(idealdata=bin_irt_2pl_sim,
                               ...
                               restrict_ind_low = as.character(sort(bin_irt_2pl_sim@simul_data$true_person,
                                                        ...
                                                        index=T)$ix[1]),
                               fixtype='prefix',
                           person_sd = 3,debug_mode = TRUE,
                           nchains=1,ncores=1,niters = 1,warmup=1,
                           compile_optim = F,num_pathfinder_paths = 6)
...
bin_time_ar_irt_2pl_abs_sim <- id_sim_gen(num_person=20,num_bills=100,inflate=T,
                               absence_diff_mean=0,time_process = 'AR',time_points=20,time_sd = .1,diff_sd = 1,
                               absence_discrim_sd = 1,
                               reg_discrim_sd = 1)
