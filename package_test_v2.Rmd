...
bin_irt_2pl_est <- id_estimate(idealdata=bin_irt_2pl_sim,
                               ...
                               fixtype='prefix',
                           person_sd = 3,
                           nchains=4,ncores=4,compile_optim = F)
...
bin_time_irt_2pl_abs_sim <- id_sim_gen(num_person=50,num_bills=100,
                                       ordinal=F,inflate=T,
                               absence_diff_mean=0,
                               time_process = 'random',
                               time_points=10,
...
bin_time_spline_irt_2pl_abs_sim <- id_sim_gen(num_person=100,num_bills=200,inflate=F,
                               absence_diff_mean=0,
                               time_process = 'random',
                               time_points=20,time_sd = .25,diff_sd = 1,
                               absence_discrim_sd = 1,
                               reg_discrim_sd = 1)
...
bin_time_spline_irt_2pl_abs_est <- id_estimate(idealdata=bin_time_spline_irt_2pl_abs_sim,
                               ...
                               spline_knots=3,spline_degree = 3,
                               const_type = "items",person_sd = 3,
                               time_var = 1,restrict_var = F,
                               restrict_ind_high = as.character(sort(bin_time_spline_irt_2pl_abs_sim@simul_data$true_reg_discrim,
                                                                     decreasing=TRUE,
                                                        index=TRUE)$ix[1]),
                              restrict_ind_low =as.character(sort(bin_time_spline_irt_2pl_abs_sim@simul_data$true_reg_discrim,,
                                                                   decreasing=F,
                                                        index=T)$ix[1]),
...
bin_time_ar_irt_2pl_abs_sim <- id_sim_gen(num_person=20,num_bills=200,inflate=T,
                               absence_diff_mean=0,time_process = 'AR',time_points=50,time_sd = .1,diff_sd = 1,
                               absence_discrim_sd = 1,
                               reg_discrim_sd = 1)
...
bin_time_ar_irt_2pl_abs_est <- id_estimate(idealdata=bin_time_ar_irt_2pl_abs_sim,
                                           use_groups = F,
                               model_type=2,time_center_cutoff = 5,
                               ar1_up = 1,ar1_down = -1,
                               ncores = parallel::detectCores(),
                               vary_ideal_pts = 'AR1',
                               const_type = "items",
                               time_var = 10,restrict_var = T,
