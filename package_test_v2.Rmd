...
bin_time_ar_irt_2pl_abs_sim <- id_sim_gen(num_person=20,num_items=200,inflate=T,
...
id_plot_legis_dyn(bin_time_ar_irt_2pl_abs_est,show_true = F) + guides(colour="none") + facet_wrap(~person_id,scales="free_y")
```
