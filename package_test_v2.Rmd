...
bin_time_irt_2pl_abs_sim <- id_sim_gen(num_person=20,num_bills=1000,
                                       ordinal=F,inflate=T,
                               absence_diff_mean=0,
                               time_process = 'random',
                               time_points=10,
...
bin_time_irt_2pl_abs_est <- id_estimate(idealdata=bin_time_irt_2pl_abs_sim,
                          ...
                          restrict_sd_low = .001,
                          fix_high=sort(bin_time_irt_2pl_abs_sim@simul_data$true_reg_discrim,
                                                                  
                                                                  decreasing=TRUE)[1],
                          fix_low=sort(bin_time_irt_2pl_abs_sim@simul_data$true_reg_discrim,
