...
latent_noninfl_est <- id_estimate(idealdata=latent_noninfl_sim,
                              ...
                              restrict_ind_low = as.character(sort(latent_noninfl_sim@simul_data$true_person,
                                                                   decreasing=F,
                                                        index=T)$ix[1]),fix_high = sort(latent_noninfl_sim@simul_data$true_person,
                                                                     decreasing=T)[1],fix_low = sort(latent_noninfl_sim@simul_data$true_person,
                                                                     decreasing=F)[1],
...
latent_infl_sim <- id_sim_gen(num_person=10,num_items=125,ordinal=F,
                                       inflate=T,
                                       model_type='binary',
                                       latent_space=T)
