...
```{r irt_binary}
bin_irt_2pl_sim <- id_sim_gen(num_person=300,num_bills=5,ordinal=F,inflate=F,
                              diff_sd=1,
                              reg_discrim_sd = 1,
...
bin_time_irt_2pl_abs_est <- id_estimate(idealdata=bin_time_irt_2pl_abs_sim,
                               model_type=2,niters = 2,warmup = 1,keep_param=list(person_vary=T,person_int=F,item=TRUE,
                                                           extra=T),
