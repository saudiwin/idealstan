...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(704, 311, "end", "/chunks/model_types.stan");
    reader.add_event(704, 167, "restart", "model_irt_standard_noid");
    reader.add_event(710, 171, "end", "model_irt_standard_noid");
    return reader;
}
