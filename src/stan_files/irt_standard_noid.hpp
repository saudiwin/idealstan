...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(706, 311, "end", "/chunks/model_types.stan");
    reader.add_event(706, 176, "restart", "model_irt_standard_noid");
    reader.add_event(712, 180, "end", "model_irt_standard_noid");
    return reader;
}
