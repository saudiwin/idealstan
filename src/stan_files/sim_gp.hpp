...
private:
        ...
        double alpha;
        double sigma;
        std::vector<matrix_d> cov;
        std::vector<matrix_d> L_cov;
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            cov = std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >(N, Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(T, T));
            ...
            L_cov = std::vector<Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> >(N, Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(T, T));
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> f(N, T);
            ...
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> Y(N, T);
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_2__ = 0; j_2__ < Y_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < Y_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "Y" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
    }
