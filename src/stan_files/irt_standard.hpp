...
jacob_mean(const int& N,
    ...
    try {
        ...
        stan::math::assign(density, sum(log(col_vec)));
            ...
            if (as_bool(logical_eq(model_type,1))) {
                ...
                if (as_bool(logical_eq(T,1))) {
                    ...
                    for (int n = 1; n <= N; ++n) {
                        ...
                        stan::math::assign(get_base1_lhs(pi1,n,"pi1",1), ((get_base1(sigma_reg_free,get_base1(bb,n,"bb",1),"sigma_reg_free",1) + get_base1(sigma_abs_free,get_base1(bb,n,"bb",1),"sigma_abs_free",1)) - sqrt(square((get_base1(get_base1(L_tp1,get_base1(time,n,"time",1),"L_tp1",1),get_base1(ll,n,"ll",1),"L_tp1",2) - get_base1(B_int_free,get_base1(bb,n,"bb",1),"B_int_free",1))))));
                    }
                }
                ...
                if (as_bool(logical_eq(T,1))) {
                    ...
                    stan::math::assign(pi1, minus(sqrt(square(subtract(stan::model::rvalue(L_full, stan::model::cons_list(stan::model::index_multi(ll), stan::model::nil_index_list()), "L_full"),stan::model::rvalue(B_int_free, stan::model::cons_list(stan::model::index_multi(bb), stan::model::nil_index_list()), "B_int_free"))))));
                    current_statement_begin__ = 815;
                    stan::math::assign(pi2, minus(sqrt(square(subtract(stan::model::rvalue(L_full, stan::model::cons_list(stan::model::index_multi(ll), stan::model::nil_index_list()), "L_full"),stan::model::rvalue(A_int_free, stan::model::cons_list(stan::model::index_multi(bb), stan::model::nil_index_list()), "A_int_free"))))));
                } else {
                    ...
                    for (int n = 1; n <= N; ++n) {
                        ...
                        stan::math::assign(get_base1_lhs(pi1,n,"pi1",1), -(sqrt(square((get_base1(get_base1(L_tp1,get_base1(time,n,"time",1),"L_tp1",1),get_base1(ll,n,"ll",1),"L_tp1",2) - get_base1(B_int_free,get_base1(bb,n,"bb",1),"B_int_free",1))))));
                        current_statement_begin__ = 820;
                        stan::math::assign(get_base1_lhs(pi2,n,"pi2",1), -(sqrt(square((get_base1(get_base1(L_tp1,get_base1(time,n,"time",1),"L_tp1",1),get_base1(ll,n,"ll",1),"L_tp1",2) - get_base1(A_int_free,get_base1(bb,n,"bb",1),"A_int_free",1))))));
                    }
                }
