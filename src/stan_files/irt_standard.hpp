...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(857, 213, "end", "model_irt_standard");
    return reader;
}
...
jacob_mean(const int& N,
    ...
    try {
        ...
        validate_non_negative_index("I", "N", N);
        Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  I(static_cast<Eigen::VectorXd::Index>(N),static_cast<Eigen::VectorXd::Index>(N));
        ...
        Eigen::Matrix<local_scalar_t__,1,Eigen::Dynamic>  row_vec(static_cast<Eigen::VectorXd::Index>(N));
        (void) row_vec;  // dummy to suppress unused var warning

        stan::math::initialize(row_vec, DUMMY_VAR__);
        ...
        stan::math::assign(density, stan::math::log(stan::math::fabs((num_div - multiply(multiply(row_vec,I),col_vec)))));
