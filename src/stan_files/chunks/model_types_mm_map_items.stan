  ...
  if(pad_id[n]==1) {
    ...
    if(mm[n]==1) {
      ...
      if(T==1) {
        ...
        if(order_cats_rat[n]==3) {
          if(Y_int[n]>order_cats_rat[n]) {
            // missing
            log_prob += ordered_logistic_lpmf(1|(sigma_abs_free[1] + sax_pred[n,]*sigma_abs_x) * (L_full[ll[n]] + legis_pred[n,]*legis_x) - 
            A_int_free[1],
            steps_votes3);
          } else {
            //observed
            log_prob += ordered_logistic_lpmf(Y_int[n]|(sigma_reg_free[1] + srx_pred[n,]*sigma_reg_x) *  (L_full[ll[n]] + legis_pred[n,]*legis_x) - B_int_free[1],
            steps_votes3);
            log_prob += ordered_logistic_lpmf(0|(sigma_abs_free[1] + sax_pred[n,]*sigma_abs_x) * (L_full[ll[n]] + legis_pred[n,]*legis_x) - 
            A_int_free[1],
            steps_votes3);
          }
        } else if(order_cats_rat[n]==4) {
        ...
        if(order_cats_rat[n]==3) {
          if(Y_int[n]>order_cats_rat[n]) {
            // missing
            log_prob += ordered_logistic_lpmf(1|(sigma_abs_free[1] + sax_pred[n,]*sigma_abs_x) * (L_tp1[time[n],ll[n]] + legis_pred[n,]*legis_x) - 
            A_int_free[1],
            steps_votes3);
          } else {
            //observed
            log_prob += ordered_logistic_lpmf(Y_int[n]|(sigma_reg_free[1] + srx_pred[n,]*sigma_reg_x) *  (L_tp1[time[n],ll[n]] + legis_pred[n,]*legis_x) - B_int_free[1],
            steps_votes3);
            log_prob += ordered_logistic_lpmf(0|(sigma_abs_free[1] + sax_pred[n,]*sigma_abs_x) * (L_tp1[time[n],ll[n]] + legis_pred[n,]*legis_x) - 
            A_int_free[1],
            steps_votes3);
          }
        } else if(order_cats_rat[n]==4) {
      ...
      if(Y_int[n]<y_int_miss) {
        ...
        if(T==1) {
          log_prob += poisson_log_lpmf(Y_int[n]|(sigma_reg_free[1] + srx_pred[n,]*sigma_reg_x) *  (L_full[ll[n]] + legis_pred[n,]*legis_x) - B_int_free[1]);
          log_prob += poisson_log_lpmf(0|(sigma_abs_free[1] + sax_pred[n,]*sigma_abs_x) * (L_full[ll[n]] + legis_pred[n,]*legis_x) - 
          A_int_free[1]);
        } else {
          log_prob += poisson_log_lpmf(Y_int[n]|(sigma_reg_free[1] + srx_pred[n,]*sigma_reg_x) *  (L_tp1[time[n],ll[n]] + legis_pred[n,]*legis_x) - B_int_free[1]);
          log_prob += poisson_log_lpmf(0|(sigma_abs_free[1] + sax_pred[n,]*sigma_abs_x) * (L_tp1[time[n],ll[n]] + legis_pred[n,]*legis_x) - 
          A_int_free[1]);
        }
      ...
      if(T==1) {
        log_prob += normal_lpdf(Y_cont[n-N_int]|(sigma_reg_free[1] + srx_pred[n,]*sigma_reg_x) *  (L_full[ll[n]] + legis_pred[n,]*legis_x) - B_int_free[1],
        extra_sd);
      } else {
        log_prob += normal_lpdf(Y_cont[n-N_int]|(sigma_reg_free[1] + srx_pred[n,]*sigma_reg_x) *  (L_tp1[time[n],ll[n]] + legis_pred[n,]*legis_x) - B_int_free[1],
        extra_sd);
      }
      ...
      if(T==1) {
        log_prob += lognormal_lpdf(Y_cont[n-N_int]|exp((sigma_reg_free[1] + srx_pred[n,]*sigma_reg_x) *  (L_full[ll[n]] + legis_pred[n,]*legis_x) - B_int_free[1]),
        extra_sd);
      } else {
        log_prob += lognormal_lpdf(Y_cont[n-N_int]|exp((sigma_reg_free[1] + srx_pred[n,]*sigma_reg_x) *  (L_tp1[time[n],ll[n]] + legis_pred[n,]*legis_x) - B_int_free[1]),
        extra_sd);
      }
