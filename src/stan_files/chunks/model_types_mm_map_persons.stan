    ...
    if(mm[n]==1) {
      ...
      if(T==1) {
        ...
        if(order_cats_rat[n]==3) {
          log_prob += ordered_logistic_lpmf(Y_int[n]|(sigma_reg_free[bb[n]] + srx_pred[n,]*sigma_reg_x) *  (L_full[1] + legis_pred[n,]*legis_x) - B_int_free[bb[n]],
          steps_votes3);
      ...
      if(T==1) {
        ...
        if(order_cats_rat[n]==3) {
          if(Y_int[n]>order_cats_rat[n]) {
            // missing
            log_prob += ordered_logistic_lpmf(1|(sigma_abs_free[bb[n]] + sax_pred[n,]*sigma_abs_x) * (L_full[1] + legis_pred[n,]*legis_x) - 
            A_int_free[bb[n]],
            steps_votes3);
          } else {
            //observed
            log_prob += ordered_logistic_lpmf(Y_int[n]|(sigma_reg_free[bb[n]] + srx_pred[n,]*sigma_reg_x) *  (L_full[1] + legis_pred[n,]*legis_x) - B_int_free[bb[n]],
            steps_votes3);
            log_prob += ordered_logistic_lpmf(0|(sigma_abs_free[bb[n]] + sax_pred[n,]*sigma_abs_x) * (L_full[1] + legis_pred[n,]*legis_x) - 
            A_int_free[bb[n]],
            steps_votes3);
          }
        } else if(order_cats_rat[n]==4) {
        ...
        if(order_cats_rat[n]==3) {
          if(Y_int[n]>order_cats_rat[n]) {
            // missing
            log_prob += ordered_logistic_lpmf(1|(sigma_abs_free[bb[n]] + sax_pred[n,]*sigma_abs_x) * (L_full[time[n]] + legis_pred[n,]*legis_x) - 
            A_int_free[bb[n]],
            steps_votes3);
          } else {
            //observed
            log_prob += ordered_logistic_lpmf(Y_int[n]|(sigma_reg_free[bb[n]] + srx_pred[n,]*sigma_reg_x) *  (L_full[time[n]] + legis_pred[n,]*legis_x) - B_int_free[bb[n]],
            steps_votes3);
            log_prob += ordered_logistic_lpmf(0|(sigma_abs_free[bb[n]] + sax_pred[n,]*sigma_abs_x) * (L_full[time[n]] + legis_pred[n,]*legis_x) - 
            A_int_free[bb[n]],
            steps_votes3);
          }
        } else if(order_cats_rat[n]==4) {
      ...
      if(Y_int[n]<y_int_miss) {
        ...
        if(T==1) {
          log_prob += poisson_log_lpmf(Y_int[n]|(sigma_reg_free[bb[n]] + srx_pred[n,]*sigma_reg_x) *  (L_full[1] + legis_pred[n,]*legis_x) - B_int_free[bb[n]]);
          log_prob += poisson_log_lpmf(0|(sigma_abs_free[bb[n]] + sax_pred[n,]*sigma_abs_x) * (L_full[1] + legis_pred[n,]*legis_x) - 
          A_int_free[bb[n]]);
        } else {
          log_prob += poisson_log_lpmf(Y_int[n]|(sigma_reg_free[bb[n]] + srx_pred[n,]*sigma_reg_x) *  (L_full[time[n]] + legis_pred[n,]*legis_x) - B_int_free[bb[n]]);
          log_prob += poisson_log_lpmf(0|(sigma_abs_free[bb[n]] + sax_pred[n,]*sigma_abs_x) * (L_full[time[n]] + legis_pred[n,]*legis_x) - 
          A_int_free[bb[n]]);
        }
        ...
        //missing data
        if(T==1) {
          log_prob += poisson_log_lpmf(1|(sigma_abs_free[bb[n]] + sax_pred[n,]*sigma_abs_x) * (L_full[1] + legis_pred[n,]*legis_x) - 
          A_int_free[bb[n]]);
        } else {
          log_prob += poisson_log_lpmf(1|(sigma_abs_free[bb[n]] + sax_pred[n,]*sigma_abs_x) * (L_full[time[n]] + legis_pred[n,]*legis_x) - 
          A_int_free[bb[n]]);
        }
      }
      ...
      if(T==1) {
        ...
        log_prob += bernoulli_logit_lpmf(Y_int[n]|ls_int[ll[n]]  + sigma_abs_free[bb[n]] -  sqrt(square( (L_full[1] + legis_pred[n,]*legis_x) - (B_int_free[bb[n]] + srx_pred[n,]*sigma_reg_x))));
      ...
      if(T==1) {
        if(Y_int[n]<y_int_miss) {
          log_prob += log(2) + bernoulli_logit_lpmf(Y_int[n]|(- sqrt(square((L_full[1] + legis_pred[n,]*legis_x) - (B_int_free[bb[n]] + srx_pred[n,]*sigma_reg_x)))));
          log_prob += log(2) + bernoulli_logit_lpmf(0|( - sqrt(square((L_full[1] + legis_pred[n,]*legis_x) - (A_int_free[bb[n]] + sax_pred[n,]*sigma_abs_x)))));
        } else {
          log_prob += log(2) + bernoulli_logit_lpmf(Y_int[n]|0 - sqrt(square((L_full[1] + legis_pred[n,]*legis_x) - (B_int_free[bb[n]] + srx_pred[n,]*sigma_reg_x))));
        }
        
      } else {
        if(Y_int[n]<y_int_miss) {
          log_prob += log(2) + bernoulli_logit_lpmf(Y_int[n]|0 - sqrt(square((L_full[1] + legis_pred[n,]*legis_x) - (B_int_free[bb[n]] + srx_pred[n,]*sigma_reg_x))));
          log_prob += log(2) + bernoulli_logit_lpmf(0|0 - sqrt(square((L_full[1] + legis_pred[n,]*legis_x) - (A_int_free[bb[n]] + sax_pred[n,]*sigma_abs_x))));
        } else {
          log_prob += log(2) + bernoulli_logit_lpmf(Y_int[n]|0 - sqrt(square((L_full[1] + legis_pred[n,]*legis_x) - (B_int_free[bb[n]] + srx_pred[n,]*sigma_reg_x))));
        }
      }
      ...
      if(T==1) {
        log_prob += normal_lpdf(Y_cont[n-N_int]|(sigma_reg_free[bb[n]] + srx_pred[n,]*sigma_reg_x) *  (L_full[1] + legis_pred[n,]*legis_x) - B_int_free[bb[n]],
        extra_sd);
      } else {
        log_prob += normal_lpdf(Y_cont[n-N_int]|(sigma_reg_free[bb[n]] + srx_pred[n,]*sigma_reg_x) *  (L_full[time[n]] + legis_pred[n,]*legis_x) - B_int_free[bb[n]],
        extra_sd);
      }
      ...
      if(T==1) {
        log_prob += lognormal_lpdf(Y_cont[n-N_int]|exp((sigma_reg_free[bb[n]] + srx_pred[n,]*sigma_reg_x) *  (L_full[1] + legis_pred[n,]*legis_x) - B_int_free[bb[n]]),
        extra_sd);
      } else {
        log_prob += lognormal_lpdf(Y_cont[n-N_int]|exp((sigma_reg_free[bb[n]] + srx_pred[n,]*sigma_reg_x) *  (L_full[time[n]] + legis_pred[n,]*legis_x) - B_int_free[bb[n]]),
        extra_sd);
      }
