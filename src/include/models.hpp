        ...
        try {
            {
                ...
                if (as_bool(logical_eq(model_type,4))) {
...
namespace model_irt_standard_current_namespace {
...
class model_irt_standard_current : public prob_grad {
private:
    int N;
    int T;
    vector<int> Y;
    ...
    vector<int> Y_new;
public:
    model_irt_standard_current(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_irt_standard_current_namespace::model_irt_standard_current";
        (void) function__;  // dummy to suppress unused var warning
        size_t pos__;
        (void) pos__;  // dummy to suppress unused var warning
        std::vector<int> vals_i__;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_irt_standard_current_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
    ...
    static std::string model_name() {
        return "model_irt_standard_current";
    }
