...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(1464, 1462, "end", "model_irt_standard");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > L_free;
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > restrict_low;
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > restrict_high;
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > pinned_pars;
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > restrict_ord;
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > L_full(T, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(num_legis))));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  sigma_abs_full(static_cast<Eigen::VectorXd::Index>(num_bills));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  sigma_reg_full(static_cast<Eigen::VectorXd::Index>(num_bills));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  B_int_full(static_cast<Eigen::VectorXd::Index>(num_bills));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  A_int_full(static_cast<Eigen::VectorXd::Index>(num_bills));
            ...
            if (as_bool(logical_eq(constrain_par,1))) {
                ...
                if (as_bool(logical_eq(constraint_type,1))) {
                    ...
                    for (int t = 1; t <= T; ++t) {
                        ...
                        stan::model::assign(L_full, 
                                    stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                    append_row(get_base1(L_free,t,"L_free",1),get_base1(restrict_low,t,"restrict_low",1)), 
                                    "assigning variable L_full");
                    }
                    ...
                    for (int t = 1; t <= T; ++t) {
                        ...
                        stan::model::assign(L_full, 
                                    stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                    append_row(get_base1(L_free,t,"L_free",1),get_base1(restrict_high,t,"restrict_high",1)), 
                                    "assigning variable L_full");
                    }
                } else if (as_bool(logical_eq(constraint_type,3))) {
                    ...
                    for (int t = 1; t <= T; ++t) {
                        ...
                        stan::model::assign(L_full, 
                                    stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                    append_row(get_base1(L_free,t,"L_free",1),append_row(get_base1(restrict_high,t,"restrict_high",1),get_base1(restrict_low,t,"restrict_low",1))), 
                                    "assigning variable L_full");
                    }
                    ...
                    for (int t = 1; t <= T; ++t) {
                        ...
                        stan::model::assign(L_full, 
                                    stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                    append_row(get_base1(L_free,t,"L_free",1),get_base1(pinned_pars,t,"pinned_pars",1)), 
                                    "assigning variable L_full");
                    }
                }
            ...
            if (as_bool(logical_eq(model_type,1))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(pi1, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                ((get_base1(sigma_reg_full,get_base1(bb,n,"bb",1),"sigma_reg_full",1) * get_base1(get_base1(L_full,get_base1(time,n,"time",1),"L_full",1),get_base1(ll,n,"ll",1),"L_full",2)) - get_base1(B_int_full,get_base1(bb,n,"bb",1),"B_int_full",1)), 
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(pi2, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                ((get_base1(sigma_abs_full,get_base1(bb,n,"bb",1),"sigma_abs_full",1) * get_base1(get_base1(L_full,get_base1(time,n,"time",1),"L_full",1),get_base1(ll,n,"ll",1),"L_full",2)) - get_base1(A_int_full,get_base1(bb,n,"bb",1),"A_int_full",1)), 
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(248, 246, "end", "model_irt_standard_noid");
    return reader;
}
