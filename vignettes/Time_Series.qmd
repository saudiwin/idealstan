...
id_plot_persons_dyn(del_est,use_ci = T) +
...
id_plot_persons_dyn(del_est_spline,use_ci = F)
  # scale_color_manual(values=c(R='red',
  #                             D='blue',
  #                             X='green'))
```
...
del_est_rw3 <- id_estimate(delaware_data,
                ...
                vary_ideal_pts='random_walk',
            seed=84520)
id_plot_persons_dyn(del_est_rw3,
...
```{r party_mid}
id_plot_persons_dyn(del_est_rw3,item_plot='342',
                  text_size_label = 5,
                  include=c('D','R')) + scale_colour_manual(values=c(R='red',
                                                          D='blue',
                                                          I='green'),
...
```{r compare_mods}
id_plot_persons_dyn(del_est_rw3,include=c('D','R'))
id_plot_persons_dyn(del_est_gp1,include=c('D','R'))
```
