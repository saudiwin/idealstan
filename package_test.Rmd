...
bin_irt_2pl_est <- id_estimate(idealdata=bin_irt_2pl_sim,
                               model_type=1,
                               restrict_ind_high = sort(bin_irt_2pl_sim@simul_data$true_reg_discrim,decreasing=T,
                                                        index=T)$ix[1:3],
                               restrict_ind_low = sort(bin_irt_2pl_sim@simul_data$true_reg_discrim,decreasing=F, 
                                                        index=T)$ix[1:3],
...
bin_irt_2pl_abs_est <- id_estimate(idealdata=bin_irt_2pl_abs_sim,
                               model_type=2,
                               restrict_ind_high = sort(bin_irt_2pl_abs_sim@simul_data$true_reg_discrim,decreasing=T,
                                                        index=T)$ix[1:3],
                              restrict_ind_low = sort(bin_irt_2pl_abs_sim@simul_data$true_reg_discrim,decreasing=F,
                                                        index=T)$ix[1:3],
                              restrict_params = 'discrim_reg', 
                              restrict_type = 'constrain_twoway',
                               fixtype='constrained',
...
ord_irt_est <- id_estimate(idealdata=ord_irt_sim,
                               model_type=3,
                               restrict_ind_high = sort(ord_irt_sim@simul_data$true_reg_discrim,decreasing=T,
                                                        index=T)$ix[1:3],
                              restrict_ind_low = sort(ord_irt_sim@simul_data$true_reg_discrim,decreasing=F,
                                                        index=T)$ix[1:3],
                           restrict_params = 'discrim_reg',
                               restrict_type = 'constrain_twoway',
                               fixtype='constrained',
...
ord_irt_abs_est <- id_estimate(idealdata=ord_irt_abs_sim,
                               model_type=4,
                               restrict_ind_high = sort(ord_irt_abs_sim@simul_data$true_reg_discrim,decreasing=T,
                                                        index=T)$ix[1:3],
                              restrict_ind_low = sort(ord_irt_abs_sim@simul_data$true_reg_discrim,decreasing=F,
                                                        index=T)$ix[1:3],
                              restrict_params = 'discrim_reg', 
                              restrict_type = 'constrain_twoway',
                               fixtype='constrained',
