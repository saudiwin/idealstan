...
```{r irt_ordinal}
ord_irt_sim <- id_sim_gen(num_person=20,num_bills=100,ordinal=T,inflate=F,
...
```{r irt_ordinal_abs}
ord_irt_abs_sim <- id_sim_gen(num_person=20,num_bills=100,ordinal=T,inflate=T,
                               absence_diff_mean=0,model_type='ordinal_ratingscale')
...
```{r irt_ordinal_grm}
ord_irt_grm_sim <- id_sim_gen(num_person=20,num_bills=100,ordinal=T,inflate=F,
...
ord_irt_grm_abs_sim <- id_sim_gen(num_person=20,num_bills=100,ordinal=T,inflate=T,
                               absence_diff_mean=0,model_type='ordinal_grm')
...
ord_irt_poisson_sim <- id_sim_gen(num_person=20,num_bills=100,ordinal=F,inflate=F,
...
```{r irt_abs_poisson}
ord_irt_poisson_sim <- id_sim_gen(num_person=20,num_bills=100,ordinal=T,inflate=F,
                               absence_diff_mean=0,model_type='poisson')
ord_irt_poisson_est <- id_estimate(idealdata=ord_irt_poisson_sim,
                               model_type=7,
                               restrict_ind_high = as.character(sort(ord_irt_poisson_sim@simul_data$true_person,
...
```{r irt_normal_abs}
ord_irt_normal_abs_sim <- id_sim_gen(num_person=20,num_bills=100,ordinal=F,inflate=F,
                               absence_diff_mean=0,model_type='normal')
