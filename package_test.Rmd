...
```{r irt_binary}
bin_irt_2pl_sim <- id_sim_gen(num_person=20,num_bills=200,ordinal=F,absence=F,
                              diff_sd=1,
                              reg_discrim_sd = 1,
...
bin_time_irt_2pl_abs_sim <- id_sim_gen(num_person=20,num_bills=125,ordinal=F,absence=T,
...
bin_time_ar_irt_2pl_abs_sim <- id_sim_gen(num_person=20,num_bills=200,ordinal=F,absence=T,
