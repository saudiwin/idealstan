...
This plot shows minor pertubations in the ideal points of individual senators with a high level of relative stability over time. It provides strong evidence that a stationary model fits the data well. Given the short time frame, we would expect the Senator's ideal points to be more or less stationary.
